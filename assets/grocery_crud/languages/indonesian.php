...
/* Translated by: M. Yuhdi & Ibrahim Yusuf */
	...
	$lang['list_displaying']		= 'Data {start} - {end} dari total {results} data';
	$lang['list_filtered_from']		= '(Hasil pencarian dari total {total_results} data)';
	...
	$lang['alert_delete']			= 'Apakah anda yakin ingin menghapus data ini ?';
	...
	$lang['message_prompt_delete_file'] 	= "Apakah anda yakin ingin menghapus data ini ?";
	...
	$lang['alert_delete_multiple'] = 'Apakah anda yakin ingin menghapus {items_amount} data ini ?';

	$lang['alert_delete_multiple_one'] = 'Apakah anda yakin Ingin menghapus 1 data ini ?';
